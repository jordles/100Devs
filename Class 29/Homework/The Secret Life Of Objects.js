...
console.group('The Secret Life Of Objects');
...
class Vec{
  ...
  get length(){
    return Math.sqrt(this.x * this.x + this.y * this.y); //pythagorean
  }
}
...
class Group{
  ...
  delete(value){
    if(this.group.includes(value)) this.group.splice(this.group.indexOf(value), 1);
  }
  ...
  static from(iterable){
    let group = new Group();
    for(let value of iterable) group.add(value);
    return group;
...
console.groupEnd('The Secret Life Of Objects')